...
import accommodationService from "./pictures/accommodationServices.webp"
import transportationService from "./pictures/transportationServices.webp"
import healthcareService from "./pictures/healthcareServices.webp"
const Services = () => {
return (
          ...
          <div className='row'>
            <div className='col-lg-4 col-6'>
              <div className='services_content'>
                <span className='icon_services'><img src={accommodationService} className='icon_img' alt='icon'></img></span>
            ...
            <div className='col-lg-4 col-6'>
              <div className='services_content'>
                <span className='icon_services'><img src={transportationService} className='icon_img' alt='icon'></img></span>
            ...
            <div className='col-lg-4 col-6 service-3'>
              <div className='services_content service_content_3'>
                <span className='icon_services'><img src={healthcareService} className='icon_img' alt='icon'></img></span>
