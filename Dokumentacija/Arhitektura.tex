		...
		%\textit{Potrebno je opisati koju vrstu i implementaciju baze podataka ste odabrali, glavne komponente od kojih se sastoji i slično.}
			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}TypeID & SMALLINT & Jedinstveni brojčani identifikator vrste smještaja, automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}EquippedID & SMALLINT & Jedinstveni brojčani identifikator opremljenosti smještaja, automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}TransporterID & BIGSERIAL & Jedinstveni brojčani identifikator prijevoznika, automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}VehicleID & BIGSERIAL & Jedinstveni brojčani identifikator vozila, automatski generiran \\ \hline
