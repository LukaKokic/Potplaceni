		...
		%\textit{Potrebno je opisati koju vrstu i implementaciju baze podataka ste odabrali, glavne komponente od kojih se sastoji i slično.}
			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}ClinicID & INT	& Jedinstveni brojčani identifikator klinike,automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}TownID & INT & Jedinstveni brojčani identifikator grada, automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}UserID & INT & Jedinstveni brojčani identifikator korisnika, automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}UserID & INT & ID korisnika kojem pripadaju korisničko ime i lozinka \\ \hline
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}PatientID & INT & Jedinstveni brojčani identifikator pacijenta, automatski generiran \\ \hline
					...
					\SetCell{LightBlue}AccomodationID & INT & ID smještaja u kojem je smješten pacijent \\ \hline
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}AccomodationID & INT & Jedinstveni brojčani identifikator smještaja, automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}TypeID & INT & Jedinstveni brojčani identifikator vrste smještaja, automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}EquippedID & INT & Jedinstveni brojčani identifikator opremljenosti smještaja, automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}AccomodationID & ID & ID smještaja \\ \hline 
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}TransporterID & INT & Jedinstveni brojčani identifikator prijevoznika, automatski generiran \\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}VehicleID & INT & Jedinstveni brojčani identifikator vozila, automatski generiran \\ \hline
					...
					\SetCell{LightBlue}TransporterID & INT & ID prijevoznika kojem vozilo pripada \\ \hline
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}PatientID & INT & ID pacijenta kojem je vozilo dodijeljeno \\ \hline
					\SetCell{LightBlue}VehicleID & INT & ID vozila koje je zauzeto \\ \hline
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}VehicleID & INT & ID vozila koje zauzeto u vremenskom razdoblju \\ \hline
				\end{longtblr}
