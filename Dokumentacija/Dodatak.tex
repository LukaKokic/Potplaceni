\chapter*{Dodatak: Prikaz aktivnosti grupe}
		...
		\begin{figure}[H]
			\includegraphics[width=\textwidth]{slike/activityfinal.png} %veličina u odnosu na širinu linije
			\caption{Dijagram aktivnosti commitova}
			\label{fig:Dijagram aktivnosti commitova} %label mora biti drugaciji za svaku sliku
		\end{figure}
